    ...
    <div className="opacity-0 animate-fade-in bg-gradient-to-tr from-emerald-50 to-teal-100 dark:from-slate-800 dark:to-slate-900 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 h-full border border-emerald-100 dark:border-slate-700 ">
      <div className="p-5 flex flex-col h-full relative">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="p-2 rounded-full transition-colors cursor-pointer bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-300 hover:bg-emerald-200 dark:hover:bg-emerald-800/30"
            >
              <svg
                className="w-6 h-6"
                fill="none"
        ...
        <div className="flex-grow flex flex-col items-center">
          ...
          <h2 className="text-xl lg:text-xl font-bold text-slate-800 dark:text-white text-center mb-4 break-words hyphens-auto px-2 leading-tight">
            {recipe.name}
          </h2>
        </div>
        <div className="flex flex-col items-center w-full mt-auto space-y-4">
          <div className="flex items-center justify-center">
            <span className="text-base lg:text-lg font-medium text-emerald-600 dark:text-emerald-400">
          ...
          <div className="flex items-center justify-around w-full text-slate-700 dark:text-slate-300 text-xs lg:text-sm gap-2">
            <div className="flex items-center flex-shrink-0 bg-emerald-50 dark:bg-emerald-900/30 px-3 py-1.5 rounded-full">
              <svg
                className="w-4 h-4 text-emerald-500 dark:text-emerald-400 mr-1.5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <button
            ...
            className="w-full px-4 py-2 cursor-pointer bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl hover:from-emerald-600 hover:to-teal-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl font-medium"
          >
            View More
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-6 lg:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 mb-10">
          <h1 className="text-3xl lg:text-5xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400 bg-clip-text text-transparent">
            Recipe Collection
          </h1>
          <button
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
            {[...Array(8)].map((_, index) => (
              <div
                key={index}
                className="animate-pulse bg-emerald-100/50 dark:bg-slate-800/50 rounded-2xl h-96"
              ></div>
            ))}
          </div>
        ) : error ? (
          <div className="text-center py-12 bg-white/50 dark:bg-slate-800/50 rounded-2xl backdrop-blur-sm">
            <div className="text-rose-500 dark:text-rose-400 text-xl font-medium mb-4">
